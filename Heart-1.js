...
const isnsfw = JSON.parse(fs.readFileSync('./Gallery/Gallery/database/nsfw.json'));
...
Maria.sendMessage(m.chat, { caption: mess.success, image: { url: Mariayresult.url } }, { quoted: m })
break
...
Maria.sendMessage(m.chat, { caption: mess.success, image: { url:waifudd.data.url } }, { quoted: m })
break
